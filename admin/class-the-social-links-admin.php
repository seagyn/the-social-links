 ...
 * @subpackage The_Social_Links/admin
 */
...
class The_Social_Links_Admin {
	...
	public function enqueue_scripts() {
		...
		wp_enqueue_script( $this->plugin_name, plugin_dir_url( __FILE__ ) . 'js/the-social-links-admin.js', array( 'jquery' ), $this->version, false );
